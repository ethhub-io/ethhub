title: Ecosystem Outline - EthHub

description: This is an outline of the current Ethereum ecosystem and all the types of applications that have been built on Ethereum so far. Most applications today fall into the following categories.

# Ecosystem Outline

This is an outline of the current Ethereum ecosystem and all the types of applications that have been built on Ethereum so far. Most applications today fall into the following categories.
